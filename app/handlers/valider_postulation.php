...
if ($lettreFile['error'] === 0) {
    ...
    $cheminLettre =  '/var/www/html/Xcelstage/public/uploads/' . $nomUniqueLettre;
...
if ($cv['error'] === 0) {
    ...
    $cheminCVServeur = '/var/www/html/Xcelstage/public/uploads/' . $nomUnique;
    $cheminCV = '/var/www/html/Xcelstage/public/uploads/' . $nomUnique; // Chemin relatif enregistré en base
...
echo "<a href='/Xcelstage/app/controllers/pageoffre.php?action=recherche'>Retour à la recherche</a>";